...
Common.prototype.decimalToHexString = function(num) {
...
Common.prototype.getDeviceType = function() {
    var u = navigator.userAgent;
    if (typeof QuickAccess !== 'undefined' && QuickAccess.isDexModeEnabled != undefined) {
        if (QuickAccess.isDexModeEnabled()) {
            return this.deviceType.DEX;
        }
    }
...
Common.prototype.isLandscapeMode = function() {
