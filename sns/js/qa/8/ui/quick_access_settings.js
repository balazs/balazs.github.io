...
QuickAccessSettings.prototype.createItemHtmlString = function (itemData, index) {
    ...
    if(itemData.link === 'add_qa_link')
        ...
        item += '<div class="item-content quickAccess-item" title="' + itemData.link + '">';
    if (itemData.icon == 'none' || itemData.icon == 'error' || itemData.icon == 'BeforeIconSearch') {
        item += '<div class="failed-img" title="' + itemData.title + '"style="background-color:#bababa; color:#fafafa;font-size:22px;font-family:Roboto condensed;font-weight:300;">' + itemData.title.charAt(0).toUpperCase() + '</div>';
    } else if (itemData.icon == "" && itemData.color) {
        if (itemData.color != -1) {
            item += '<div class="failed-img" title="' + itemData.title + '" color="' + itemData.color + '" style="background-color:#' + common.decimalToHexString(itemData.color) + ';color:#fafafa;font-size:22px;font-family:Roboto condensed;font-weight:300;">' + itemData.firstletter + '</div>';
        } else {
            item += '<div class="failed-img" title="' + itemData.title + '"style="background-color:#bababa; color:#fafafa;font-size:22px;font-family:Roboto condensed;font-weight:300;">' + itemData.firstletter + '</div>';
        }
    } else {
